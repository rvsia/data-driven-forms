...
const ColPf4 = ({ children, xs, md }) => (
  <GridItem span={ xs || md }>{ children }</GridItem>
);
...
const pf4Config = {
  Button: ({ bsStyle, children, ...rest }) => (
    <Pf4Button { ...rest } variant={ bsStyle || rest.variant }>
      { children }
    </Pf4Button>
  ),
  Col: ColPf4,
